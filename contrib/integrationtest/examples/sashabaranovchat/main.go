// This example drives the community sashabaranov/go-openai client
// through the langfuseopenai adapter: an ordinary streaming chat call
// whose model,
...
//	go run ./examples/sashabaranovchat
//

...
import (
	...
	"github.com/fgn/langfuse-go/internal/otlpreceiver"
...
func assertObservationWireEnvelope(t *testing.T, span wireSpan) {
	...
	if span.scope.Name != "langfuse-sdk" || span.scope.Version != "0.1.0" {
		t.Fatalf("instrumentation scope = (%q, %q), want (langfuse-sdk, 0.1.0)", span.scope.Name, span.scope.Version)
	}

// Module validation holds the opt-in real-provider validation suite:
// slow, deliberate, credentialed checks that never run in task ci and
// are excluded from the released Go modules. See validation/README.md.
